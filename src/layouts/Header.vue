        ...
        <div class="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 sm:mx-auto sm:flex-row">
            ...
            <nav aria-labelledby="header-navigation"
                ...
                <ul class="flex flex-col items-center sm:flex-row">
                    <li class="font-bold sm:mr-12">Home</li>
                    <li class="text-white sm:mr-12">Shop</li>
                    <li class="text-white sm:mr-12">About Us</li>
                    <li class="text-white sm:mr-12">Blog</li>
                    <li class="text-white sm:mr-12">Contact Us</li>
                </ul>
